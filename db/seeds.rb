...
Availability.create(tutor_id: 3, day: "monday", time: "morning", start_time: 10, end_time: 11, room: 204)

Tutor.create(course_id: 1, name: "Fake2", email: "Fake2@Fake2.com")
Availability.create(tutor_id: 4, day: "monday", time: "morning", start_time: 9, end_time: 11, room: 204)

Tutor.create(course_id: 1, name: "Fake3", email: "Fake3@Fake3.com")
Availability.create(tutor_id: 5, day: "monday", time: "morning", start_time: 7, end_time: 8, room: 204)